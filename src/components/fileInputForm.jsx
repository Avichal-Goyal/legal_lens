...
//                         <h2 className="text-3xl md:text-5xl font-bold text-white">Simple Steps to Legal Clarity</h2>
...
//             <form
//                 className="max-w-xl mx-auto bg-gray-800 rounded-lg shadow-lg p-8 flex flex-col items-center gap-6"
//                 onSubmit={handleSubmit}
//             >
//                 <label
//                     htmlFor="myFileInput"
//                     className="cursor-pointer bg-cyan-600 hover:bg-cyan-700 text-white font-semibold py-2 px-6 rounded transition-colors"
//                 >
...
//                 />
//                 {selectedFile && (
//                     <p className="text-cyan-300 text-center break-all">
//                         Selected File: <span className="font-medium">{selectedFile.name}</span>
//                     </p>
//                 )}
//                 <button
//                     type="submit"
//                     className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-8 rounded transition-colors disabled:opacity-50"
...
function DocumentAnalyzer() {
    ...
    return (
        <div className='flex'>
            <form
                className="max-w-xl mx-auto border-2 border-xl border-white bg-transparent rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-8 mt-2"
                onSubmit={handleSubmit}
            >
                <div
                    className={`w-full border-2 ${dragActive ? "border-cyan-400 bg-transparent" : "border-gray-600 bg-transparent"} border-dashed rounded-xl flex flex-col items-center justify-center p-8 transition-all duration-200 cursor-pointer`}
                    onClick={handleClick}
